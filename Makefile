.PHONY: all build generate clean image test test-setup test-clean
...
help:
	...
	@echo "  test-mcp     - Run MCP client"
	@echo "  test-e2e     - Run end-to-end tests"
	@echo "  test-clean   - Clean Python test environment"
	@echo "  test-setup   - Setup Python test environment"
